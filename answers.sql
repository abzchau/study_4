...
SELECT models.name AS model_name, brands.name AS brand_name, brands.headquarters FROM models JOIN brands ON models.brand_id=brands.brand_id WHERE models.name='Mustang';
...
SELECT brand_id, name, founded, headquarters, discontinued  FROM brands WHERE founded=1852 OR founded=1901 OR founded=1902 ORDER BY founded ASC;
...
SELECT model_id, year, brand_id, name FROM models WHERE model_id BETWEEN 15 and 24;